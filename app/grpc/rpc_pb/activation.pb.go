...
var file_app_grpc_pb_activation_proto_rawDesc = []byte{
	...
	0x0a, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x13, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71,
...
var file_app_grpc_pb_activation_proto_goTypes = []interface{}{
	(*ActiveUserReq)(nil), // 0: user.ActiveUserReq
	(*emptypb.Empty)(nil), // 1: google.protobuf.Empty
}
var file_app_grpc_pb_activation_proto_depIdxs = []int32{
	0, // 0: user.ActivationService.ActiveUser:input_type -> user.ActiveUserReq
	1, // 1: user.ActivationService.ActiveUser:output_type -> google.protobuf.Empty
...
func (c *activationServiceClient) ActiveUser(ctx context.Context, in *ActiveUserReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/user.ActivationService/ActiveUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ActivationService_ActiveUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.ActivationService/ActiveUser",
	}
