...
var file_app_grpc_pb_activation_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x15, 0x2e, 0x75, 0x73, 0x65,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x79, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x26, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x43, 0x6f,
...
var file_app_grpc_pb_activation_proto_goTypes = []interface{}{
	(*ActivateUserReq)(nil),                  // 0: user.ActivateUserReq
	(*RegenerateConfirmationByEmailReq)(nil), // 1: user.RegenerateConfirmationByEmailReq
	(*emptypb.Empty)(nil),                    // 2: google.protobuf.Empty
}
var file_app_grpc_pb_activation_proto_depIdxs = []int32{
	0, // 0: user.ActivationService.ActivateUser:input_type -> user.ActivateUserReq
	1, // 1: user.ActivationService.RegenerateConfirmationByEmail:input_type -> user.RegenerateConfirmationByEmailReq
	2, // 2: user.ActivationService.ActivateUser:output_type -> google.protobuf.Empty
	2, // 3: user.ActivationService.RegenerateConfirmationByEmail:output_type -> google.protobuf.Empty
...
func (c *activationServiceClient) ActivateUser(ctx context.Context, in *ActivateUserReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/user.ActivationService/ActivateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *activationServiceClient) RegenerateConfirmationByEmail(ctx context.Context, in *RegenerateConfirmationByEmailReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/user.ActivationService/RegenerateConfirmationByEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ActivationService_ActivateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.ActivationService/ActivateUser",
	}
...
func _ActivationService_RegenerateConfirmationByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.ActivationService/RegenerateConfirmationByEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ActivationService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "user.ActivationService",
