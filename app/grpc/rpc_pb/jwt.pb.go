...
var file_app_grpc_pb_jwt_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x75, 0x74, 0x68, 0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x42, 0x13, 0x5a, 0x11, 0x2e, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x67, 0x72,
...
var file_app_grpc_pb_jwt_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_app_grpc_pb_jwt_proto_goTypes = []interface{}{
	(*ValidResponse)(nil), // 0: auth.ValidResponse
	(*emptypb.Empty)(nil), // 1: google.protobuf.Empty
}
var file_app_grpc_pb_jwt_proto_depIdxs = []int32{
	1, // 0: auth.JwtService.ValidActivationToken:input_type -> google.protobuf.Empty
	1, // 1: auth.JwtService.ValidToken:input_type -> google.protobuf.Empty
	0, // 2: auth.JwtService.ValidActivationToken:output_type -> auth.ValidResponse
	0, // 3: auth.JwtService.ValidToken:output_type -> auth.ValidResponse
...
type JwtServiceClient interface {
	ValidActivationToken(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ValidResponse, error)
	ValidToken(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ValidResponse, error)
}
...
func (c *jwtServiceClient) ValidActivationToken(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ValidResponse, error) {
	out := new(ValidResponse)
	err := c.cc.Invoke(ctx, "/auth.JwtService/ValidActivationToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jwtServiceClient) ValidToken(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ValidResponse, error) {
	out := new(ValidResponse)
...
type JwtServiceServer interface {
	ValidActivationToken(context.Context, *emptypb.Empty) (*ValidResponse, error)
	ValidToken(context.Context, *emptypb.Empty) (*ValidResponse, error)
}
...
func (*UnimplementedJwtServiceServer) ValidActivationToken(context.Context, *emptypb.Empty) (*ValidResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ValidActivationToken not implemented")
}
func (*UnimplementedJwtServiceServer) ValidToken(context.Context, *emptypb.Empty) (*ValidResponse, error) {
...
func _JwtService_ValidActivationToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(JwtServiceServer).ValidActivationToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.JwtService/ValidActivationToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JwtServiceServer).ValidActivationToken(ctx, req.(*emptypb.Empty))
	}
...
func _JwtService_ValidToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JwtServiceServer).ValidToken(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _JwtService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ValidActivationToken",
			Handler:    _JwtService_ValidActivationToken_Handler,
		},
		{
